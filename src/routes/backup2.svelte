<script lang="ts">
  ...
  import { fade } from 'svelte/transition'; // Importamos fade para el "fundido rápido"
...
<div class="min-h-screen bg-[#030c09] text-white font-sans overflow-x-hidden selection:bg-[#51ad7c] selection:text-white">
  ...
  <header class="fixed top-0 w-full z-50 transition-all duration-300 {scrollY > 50 ? 'bg-[#030c09]/90 backdrop-blur-md border-b border-white/5 h-20' : 'bg-transparent h-24'} flex items-center">
    <div class="max-w-7xl mx-auto px-6 w-full flex items-center justify-between">
      ...
      <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
        ...
        <!-- Botón Nosotros modificado -->
        <a href="#about" on:click|preventDefault={() => navigateTo('about')} class="hover:text-[#51ad7c] transition-colors cursor-pointer">Nosotros</a>
      ...
      <div class="relative z-20 bg-[#030c09] border-t border-white/10 shadow-[0_-50px_100px_rgba(0,0,0,1)]">
          ...
          <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              ...
              <div class="group">
                ...
                <p class="text-sm text-gray-400 text-center text-justify">
              ...
              <div class="group">
                ...
                <h3 class="text-xl font-bold text-white text-center mb-3">Diseño Estratégico</h3>
                <p class="text-sm text-gray-400 text-center text-justify">
                  Creamos la identidad visual. Prototipamos la experiencia de usuario (UX) enfocada en la conversión antes de escribir código.
                </p>
              </div>
              ...
              <div class="group">
                ...
                <p class="text-sm text-gray-400 text-center text-justify">
                  Programación a medida. Implementamos la web asegurando velocidad, SEO técnico y compatibilidad móvil perfecta.
                </p>
              </div>
              ...
              <div class="group">
                ...
                <p class="text-sm text-gray-400 text-center text-justify">
                  Lanzamiento oficial. Te entregamos las llaves y te enseñamos a gestionar tu nuevo activo digital.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="planes" class="py-24 px-6 max-w-7xl mx-auto border-t border-white/5 scroll-mt-20">
          <div class="text-center mb-16">
              <h2 class="text-3xl md:text-4xl font-bold mb-6">Planes y Tarifas</h2>
              <p class="text-gray-400 max-w-2xl mx-auto">Soluciones escalables para cada etapa de tu negocio. Transparencia total, sin costes ocultos.</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              ...
              <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-[#51ad7c]/30 transition-all duration-300 flex flex-col h-full group">
                  <div class="mb-6">
                      <h3 class="text-xl font-bold text-white mb-2">Landing Page Starter</h3>
                      <p class="text-sm text-gray-400">Ideal para validar ideas o servicios específicos.</p>
                  </div>
                  ...
                  <ul class="space-y-4 mb-8 flex-grow">
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          ...
                          <span>Landing page (1 a 4 secciones)</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                      ...
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Integración WhatsApp / Formulario</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>SEO Básico (Títulos y estructura)</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                  ...
                  <div class="pt-6 border-t border-white/10">
                      <p class="text-xs text-[#51ad7c] font-medium italic">
                          "La entrada perfecta al mundo digital."
                      </p>
              ...
              <div class="relative bg-[#05100c] border-2 border-[#51ad7c] rounded-3xl p-8 shadow-[0_0_40px_rgba(81,173,124,0.15)] flex flex-col h-full transform md:-translate-y-4">
                  ...
                  <div class="mb-6">
                      <h3 class="text-xl font-bold text-white mb-2">Business Website</h3>
                      <p class="text-sm text-gray-400">Web completa con estrategia y contenido visual propio.</p>
                  </div>
                  
                  <ul class="space-y-4 mb-8 flex-grow">
                      <li class="flex items-start gap-3 text-sm text-white font-medium">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Hasta 5–6 páginas completas</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-white font-medium">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Mini Sesión de Fotos (Local)</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Diseño con estructura estratégica</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>SEO Básico Completo</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Integración reservas / calendario</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Hosting + Dominio (1er año)</span>
                       ...
                       <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Galería o sección visual mejorada</span>
                      </li>
                  </ul>

                  <div class="pt-6 border-t border-white/10">
                      <p class="text-xs text-[#51ad7c] font-medium italic">
                          "El equilibrio perfecto: calidad visual y precio convincente."
                      </p>
              ...
              <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-[#51ad7c]/30 transition-all duration-300 flex flex-col h-full group">
                  <div class="mb-6">
                      <h3 class="text-xl font-bold text-white mb-2">Web Pro + Media</h3>
                      <p class="text-sm text-gray-400">La experiencia visual definitiva para marcas ambiciosas.</p>
                  </div>
                  
                  <ul class="space-y-4 mb-8 flex-grow">
                      <li class="flex items-start gap-3 text-sm text-white font-medium">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Todo lo incluido en plan Business</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-white font-medium">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Shooting Profesional Completo</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-white font-medium">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Video Corto Promocional</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Página galería avanzada</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                          <span>Optimización visual avanzada</span>
                      </li>
                      <li class="flex items-start gap-3 text-sm text-gray-300">
                          <svg class="w-5 h-5 text-[#51ad7c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                  ...
                  <div class="pt-6 border-t border-white/10">
                      <p class="text-xs text-[#51ad7c] font-medium italic">
                          "Premium real. Tu marca a otro nivel visual."
                      </p>
                      <a href="#contact" on:click|preventDefault={() => navigateTo('home', 'contact')} class="mt-4 block w-full py-3 rounded-xl border border-white/20 text-center text-sm font-semibold hover:bg-white/10 transition-colors">
                          Consultar Disponibilidad
                      </a>
        ...
        <!-- SECCIÓN FAQs -->
        <section class="py-24 px-6 max-w-4xl mx-auto border-t border-white/5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">Para webs corporativas estándar, el tiempo medio es de 2 a 4 semanas desde que recibimos todo el material. Proyectos más complejos se evalúan a medida.</p>
                </div>
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    <h4 class="font-bold text-white mb-2 text-lg">¿Qué incluye el servicio?</h4>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">Diseño completo, desarrollo a medida, configuración de dominio, hosting optimizado, mantenimiento técnico y la entrega total de la propiedad intelectual.</p>
                </div>
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    <h4 class="font-bold text-white mb-2 text-lg">¿Por qué elegir Poldan?</h4>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">No solo diseñamos, construimos activos. Optimizamos tu presencia online con SEO avanzado, arquitecturas modernas y una experiencia de usuario muy pulida.</p>
                </div>
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    <h4 class="font-bold text-white mb-2 text-lg">¿Tengo que pagar todo ya?</h4>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">No. Trabajamos con un esquema seguro de 50% al inicio y 50% a la entrega final del proyecto, asegurando que estés 100% satisfecho con el resultado final.</p>
                </div>
            </div>
        </section>

        <!-- CONTACT SECTION -->
        <section id="contact" class="pt-22 pb-28 px-6 border-t border-white/5 bg-gradient-to-b from-[#030c09] to-[#05100c] scroll-mt-19">
          <div class="max-w-2xl mx-auto text-center w-full">
            ...
            <form action="https://api.web3forms.com/submit" method="POST" class="space-y-4 text-left">
              ...
              <button type="submit" class="w-full bg-gradient-to-r from-[#51ad7c] to-emerald-700 hover:brightness-110 text-white font-bold py-4 rounded-xl transition-all shadow-lg transform active:scale-95 mt-4 border border-[#51ad7c]/20">
                Enviar Mensaje
              </button>
            </form>
          </div>
  ...
  {#if currentPath === 'about'}
    ...
    <div in:fade={{ duration: 300 }} class="pt-24 min-h-screen"> 
      
      <!-- BOTÓN VOLVER -->
      <div class="fixed top-24 left-6 z-40">
        <button 
          on:click={() => navigateTo('home')} 
          class="group flex items-center gap-2 px-4 py-2 bg-black/50 backdrop-blur-md border border-white/10 rounded-full text-sm text-gray-300 hover:text-white hover:border-[#51ad7c]/50 transition-all"
        >
      ...
      <section id="about" class="py-12 px-6 max-w-7xl mx-auto scroll-mt-20">
        <div class="text-center mb-16">
