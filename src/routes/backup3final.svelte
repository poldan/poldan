        ...
        <section class="py-24 px-6 max-w-4xl mx-auto border-t border-white/5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">Entregamos webs corporativas estándar en 2 a 4 semanas tras recibir todo el material. Proyectos complejos se planifican con un plazo ajustado a cada caso.</p>
                </div>
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    <h4 class="font-bold text-white mb-2 text-lg">¿Qué incluye el servicio?</h4>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">Incluye diseño y desarrollo a medida, dominio, hosting optimizado, mantenimiento técnico y la entrega total de la propiedad intelectual del proyecto.</p>
                </div>
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    <h4 class="font-bold text-white mb-2 text-lg">¿Por qué elegir Poldan?</h4>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">Diseñamos y construimos activos digitales, mejorando tu presencia online con SEO, arquitectura moderna y experiencia de usuario optimizada para tus objetivos.</p>
                </div>
                <div class="bg-white/5 p-6 rounded-2xl border border-white/5 h-full flex flex-col">
                    <h4 class="font-bold text-white mb-2 text-lg">¿Tengo que pagar todo ya?</h4>
                    <p class="text-gray-400 text-sm leading-relaxed text-justify flex-grow">No. Trabajamos con 50% al inicio y 50% al finalizar. Así aseguramos seguridad y que estés 100% satisfecho con el resultado antes de pagar lo restante.</p>
                </div>
            </div>
        </section>
